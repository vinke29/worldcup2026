...
export const MATCHES: Match[] = [
  ...
  m({ id:"a3-2", phase:"group-md3", group:"Group A", homeTeam:"South Africa", homeFlag:"🇿🇦", awayTeam:"South Korea",   awayFlag:"🇰🇷", date:"Jun 24", time:"22:00", venue:"Estadio BBVA · Guadalupe",              communityHome:30, communityDraw:30, communityAway:40, oddsHome:28, oddsDraw:30, oddsAway:42 }),
  ...
  m({ id:"b1-2", phase:"group-md1", group:"Group B", homeTeam:"Qatar",        homeFlag:"🇶🇦", awayTeam:"Switzerland",   awayFlag:"🇨🇭", date:"Jun 13", time:"21:00", venue:"Levi's Stadium · San Francisco",         communityHome:20, communityDraw:28, communityAway:52, oddsHome:18, oddsDraw:26, oddsAway:56 }),
  ...
  m({ id:"c1-2", phase:"group-md1", group:"Group C", homeTeam:"Haiti",        homeFlag:"🇭🇹", awayTeam:"Scotland",       awayFlag:"🏴󠁧󠁢󠁳󠁣󠁴󠁿", date:"Jun 13", time:"21:00", venue:"Gillette Stadium · Boston",              communityHome:22, communityDraw:28, communityAway:50, oddsHome:20, oddsDraw:27, oddsAway:53 }),
  ...
  // GROUP D
  // ══════════════════════════════════════════════════════════════════════════
  m({ id:"d1-1", phase:"group-md1", group:"Group D", homeTeam:"United States", homeFlag:"🇺🇸", awayTeam:"Paraguay",      awayFlag:"🇵🇾", date:"Jun 12", time:"21:00", venue:"SoFi Stadium · Los Angeles",             communityHome:55, communityDraw:24, communityAway:21, oddsHome:52, oddsDraw:25, oddsAway:23 }),
  m({ id:"d1-2", phase:"group-md1", group:"Group D", homeTeam:"Australia",    homeFlag:"🇦🇺", awayTeam:"Turkey",         awayFlag:"🇹🇷", date:"Jun 13", time:"18:00", venue:"BC Place · Vancouver",                   communityHome:38, communityDraw:30, communityAway:32, oddsHome:36, oddsDraw:31, oddsAway:33 }),
  ...
  // GROUP E
  // ══════════════════════════════════════════════════════════════════════════
  m({ id:"e1-1", phase:"group-md1", group:"Group E", homeTeam:"Germany",      homeFlag:"🇩🇪", awayTeam:"Curaçao",        awayFlag:"🇨🇼", date:"Jun 14", time:"18:00", venue:"NRG Stadium · Houston",                  communityHome:82, communityDraw:12, communityAway:6,  oddsHome:85, oddsDraw:10, oddsAway:5  }),
  m({ id:"e1-2", phase:"group-md1", group:"Group E", homeTeam:"Ivory Coast",  homeFlag:"🇨🇮", awayTeam:"Ecuador",        awayFlag:"🇪🇨", date:"Jun 14", time:"21:00", venue:"Lincoln Financial Field · Philadelphia",  communityHome:38, communityDraw:30, communityAway:32, oddsHome:36, oddsDraw:31, oddsAway:33 }),
  ...
  // GROUP F
  // ══════════════════════════════════════════════════════════════════════════
  m({ id:"f1-1", phase:"group-md1", group:"Group F", homeTeam:"Netherlands",  homeFlag:"🇳🇱", awayTeam:"Japan",          awayFlag:"🇯🇵", date:"Jun 14", time:"18:00", venue:"AT&T Stadium · Dallas",                  communityHome:52, communityDraw:26, communityAway:22, oddsHome:54, oddsDraw:24, oddsAway:22 }),
  m({ id:"f1-2", phase:"group-md1", group:"Group F", homeTeam:"Sweden",       homeFlag:"🇸🇪", awayTeam:"Tunisia",        awayFlag:"🇹🇳", date:"Jun 14", time:"21:00", venue:"Estadio BBVA · Guadalupe",              communityHome:55, communityDraw:25, communityAway:20, oddsHome:58, oddsDraw:23, oddsAway:19 }),
  ...
  // GROUP G
  // ══════════════════════════════════════════════════════════════════════════
  m({ id:"g1-1", phase:"group-md1", group:"Group G", homeTeam:"Iran",         homeFlag:"🇮🇷", awayTeam:"New Zealand",   awayFlag:"🇳🇿", date:"Jun 15", time:"18:00", venue:"SoFi Stadium · Los Angeles",             communityHome:45, communityDraw:28, communityAway:27, oddsHome:48, oddsDraw:26, oddsAway:26 }),
  m({ id:"g1-2", phase:"group-md1", group:"Group G", homeTeam:"Belgium",      homeFlag:"🇧🇪", awayTeam:"Egypt",         awayFlag:"🇪🇬", date:"Jun 15", time:"22:00", venue:"Lumen Field · Seattle",                 communityHome:60, communityDraw:22, communityAway:18, oddsHome:62, oddsDraw:21, oddsAway:17 }),
  ...
  // GROUP H
  // ══════════════════════════════════════════════════════════════════════════
  m({ id:"h1-1", phase:"group-md1", group:"Group H", homeTeam:"Saudi Arabia", homeFlag:"🇸🇦", awayTeam:"Uruguay",        awayFlag:"🇺🇾", date:"Jun 15", time:"18:00", venue:"Hard Rock Stadium · Miami",              communityHome:25, communityDraw:28, communityAway:47, oddsHome:22, oddsDraw:26, oddsAway:52 }),
  m({ id:"h1-2", phase:"group-md1", group:"Group H", homeTeam:"Spain",        homeFlag:"🇪🇸", awayTeam:"Cape Verde",     awayFlag:"🇨🇻", date:"Jun 15", time:"22:00", venue:"Mercedes-Benz Stadium · Atlanta",       communityHome:80, communityDraw:13, communityAway:7,  oddsHome:82, oddsDraw:11, oddsAway:7  }),
  ...
  // GROUP I
  // ══════════════════════════════════════════════════════════════════════════
  m({ id:"i1-1", phase:"group-md1", group:"Group I", homeTeam:"France",       homeFlag:"🇫🇷", awayTeam:"Senegal",        awayFlag:"🇸🇳", date:"Jun 16", time:"18:00", venue:"MetLife Stadium · New York",             communityHome:64, communityDraw:20, communityAway:16, oddsHome:66, oddsDraw:19, oddsAway:15 }),
  m({ id:"i1-2", phase:"group-md1", group:"Group I", homeTeam:"Iraq",         homeFlag:"🇮🇶", awayTeam:"Norway",         awayFlag:"🇳🇴", date:"Jun 16", time:"21:00", venue:"Gillette Stadium · Boston",              communityHome:25, communityDraw:30, communityAway:45, oddsHome:22, oddsDraw:29, oddsAway:49 }),
  ...
  m({ id:"j1-2", phase:"group-md1", group:"Group J", homeTeam:"Austria",      homeFlag:"🇦🇹", awayTeam:"Jordan",         awayFlag:"🇯🇴", date:"Jun 16", time:"21:00", venue:"Levi's Stadium · San Francisco",         communityHome:55, communityDraw:25, communityAway:20, oddsHome:58, oddsDraw:23, oddsAway:19 }),
  ...
  // GROUP K
  // ══════════════════════════════════════════════════════════════════════════
  m({ id:"k1-1", phase:"group-md1", group:"Group K", homeTeam:"Portugal",     homeFlag:"🇵🇹", awayTeam:"DR Congo",       awayFlag:"🇨🇩", date:"Jun 17", time:"18:00", venue:"NRG Stadium · Houston",                  communityHome:72, communityDraw:16, communityAway:12, oddsHome:74, oddsDraw:15, oddsAway:11 }),
  m({ id:"k1-2", phase:"group-md1", group:"Group K", homeTeam:"Uzbekistan",   homeFlag:"🇺🇿", awayTeam:"Colombia",       awayFlag:"🇨🇴", date:"Jun 17", time:"21:00", venue:"Estadio Azteca · Mexico City",          communityHome:20, communityDraw:28, communityAway:52, oddsHome:18, oddsDraw:26, oddsAway:56 }),
  ...
  // GROUP L
  // ══════════════════════════════════════════════════════════════════════════
  m({ id:"l1-1", phase:"group-md1", group:"Group L", homeTeam:"England",      homeFlag:"🏴󠁧󠁢󠁥󠁮󠁧󠁿", awayTeam:"Croatia",       awayFlag:"🇭🇷", date:"Jun 17", time:"21:00", venue:"AT&T Stadium · Dallas",                  communityHome:52, communityDraw:26, communityAway:22, oddsHome:54, oddsDraw:24, oddsAway:22 }),
  m({ id:"l1-2", phase:"group-md1", group:"Group L", homeTeam:"Ghana",        homeFlag:"🇬🇭", awayTeam:"Panama",         awayFlag:"🇵🇦", date:"Jun 17", time:"21:00", venue:"BMO Field · Toronto",                    communityHome:48, communityDraw:28, communityAway:24, oddsHome:46, oddsDraw:29, oddsAway:25 }),
