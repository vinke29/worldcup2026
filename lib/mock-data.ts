...
export const MATCHES: Match[] = [
  ...
  m({ id:"b2-2", phase:"group-md2", group:"Group B", homeTeam:"Canada",       homeFlag:"🇨🇦", awayTeam:"Qatar",          awayFlag:"🇶🇦", date:"Jun 18", time:"22:00", venue:"BC Place · Vancouver",                   communityHome:62, communityDraw:22, communityAway:16, oddsHome:65, oddsDraw:21, oddsAway:14, illustration:"/match-b-can-qat.png", imagePosition:"center 30%" }),
