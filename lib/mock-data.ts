...
export const MATCHES: Match[] = [
  ...
  // GROUP B
  // ══════════════════════════════════════════════════════════════════════════
  m({ id:"b1-1", phase:"group-md1", group:"Group B", homeTeam:"Canada",       homeFlag:"🇨🇦", awayTeam:"Bosnia & Herz.", awayFlag:"🇧🇦", date:"Jun 12", time:"18:00", venue:"BMO Field · Toronto",                   communityHome:45, communityDraw:28, communityAway:27, oddsHome:42, oddsDraw:30, oddsAway:28, illustration:"/match-b-can-bih.png", imagePosition:"center 45%" }),
